  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        surface: { DEFAULT: "hsl(var(--surface))", "2": "hsl(var(--surface-2))", elev: "hsl(var(--surface-elev))" },
        primary: { DEFAULT: "hsl(var(--primary))", foreground: "hsl(var(--primary-foreground))", glow: "hsl(var(--primary-glow))", soft: "hsl(var(--primary-soft))" },
